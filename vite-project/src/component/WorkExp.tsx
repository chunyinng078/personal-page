    ...
    <div className="flex w-full flex-col">
      ...
      <div className="card bg-base-100 w-full shadow-xl my-2">
        <div className="card-body">
          <div className=" text-xl flex justify-between">
            ...
            <span className="font-medium">19 Jan 2024 – 24 Feb 2024</span>
          </div>
      ...
      <div className="card bg-base-100 w-full shadow-xl my-2">
        <div className="card-body">
          ...
          <ul className="list-disc list-inside">
            <li>Follow Figma UI design wireframe to modify template to complete a responsive website layout with HTML, JavaScript, Tailwind CSS, and framer motion: <a href="https://www.luisortet.com" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline ">https://www.luisortet.com</a></li>
